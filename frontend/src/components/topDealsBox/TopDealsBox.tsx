          ...
          >
            <div className="flex gap-2 2xl:gap-4 items-center">
              <div className="avatar">
                <div className="xl:w-8 2xl:w-16 rounded-full">
                  <img src={user.img} alt={`user${index}`} />
                </div>
              </div>
              <div className="flex flex-col items-start gap-1">
                <span className="xl:text-[13px] 2xl:text-lg m-0 p-0">
                  {user.username}
                </span>
                <span className="hidden xl:block xl:text-[10px] 2xl:text-sm">
                  {user.email}
                </span>
              </div>
            </div>
            <span className="font-semibold xl:text-base 2xl:text-lg">
              $3.688
            </span>
          </button>
        ))}
